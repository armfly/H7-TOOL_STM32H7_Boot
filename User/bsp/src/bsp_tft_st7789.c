...
#define LCD_RS_0()  	LCD_RS_GPIO->BSRR = ((uint32_t)LCD_RS_PIN << 16U)
#define LCD_RS_1()  	LCD_RS_GPIO->BSRR = LCD_RS_PIN

/* LCD_CS SPI片选*/
#define LCD_CS_GPIO		GPIOE
#define LCD_CS_PIN		GPIO_PIN_1
#define LCD_CS_0()  	LCD_CS_GPIO->BSRR = ((uint32_t)LCD_CS_PIN << 16U)	
#define LCD_CS_1()  	LCD_CS_GPIO->BSRR = LCD_CS_PIN

/* SPI 接口 */
#define LCD_SCK_GPIO	GPIOH
#define LCD_SCK_PIN		GPIO_PIN_6
#define LCD_SCK_0()  	LCD_SCK_GPIO->BSRR = ((uint32_t)LCD_SCK_PIN << 16U)		
#define LCD_SCK_1()  	LCD_SCK_GPIO->BSRR = LCD_SCK_PIN

#define LCD_SDA_GPIO	GPIOH
#define LCD_SDA_PIN		GPIO_PIN_7
#define LCD_SDA_0()  	LCD_SDA_GPIO->BSRR = ((uint32_t)LCD_SDA_PIN << 16U)		
#define LCD_SDA_1()  	LCD_SDA_GPIO->BSRR = LCD_SDA_PIN

/* LCD_RESET 复位 */
#define LCD_RESET_GPIO	GPIOB
#define LCD_RESET_PIN	GPIO_PIN_6
#define LCD_RESET_0()  	LCD_RESET_GPIO->BSRR = ((uint32_t)LCD_RESET_PIN << 16U)		
#define LCD_RESET_1()  	LCD_RESET_GPIO->BSRR = LCD_RESET_PIN

/* LCD_PWR_EN 电源控制 */
#define LCD_PWR_EN_GPIO		GPIOH
#define LCD_PWR_EN_PIN		GPIO_PIN_15
#define LCD_PWR_EN_0()  	LCD_PWR_EN_GPIO->BSRR = ((uint32_t)LCD_PWR_EN_PIN << 16U)		
#define LCD_PWR_EN_1()  	LCD_PWR_EN_GPIO->BSRR = LCD_PWR_EN_PIN
